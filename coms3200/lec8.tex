...
\begin{table}[H]
	...
	\begin{tabular}{llllllll}
		...
		&\multicolumn{3}{c}{$\leftarrow$ Get/set header $\rightarrow$}&\multicolumn{4}{c}{$\leftarrow$ Variables to get/set $\rightarrow$}\\
		PDU Type & Request ID & Error Status & Error Index & Name & Value & Name & Value\\
		(0 - 3) && (0 - 5) &&&&&\\
		\midrule
		&\multicolumn{5}{c}{$\leftarrow$ Trap header $\rightarrow$}&\multicolumn{2}{c}{$\leftarrow$ Trap info $\rightarrow$}\\
